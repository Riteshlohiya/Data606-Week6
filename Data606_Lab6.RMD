...
Answer: The percentages appear to be sample statistics.
...
Answer: The sample would have to be randomly selected from across the world(50,000 people from 57 Countries on 5 continents). Its also less than 10%, so we can say its independent. 10 success and 10 failure also seems to be correct. This seems like a reasonaable assumption.
...
#Set my working directory as C:\Users\Arnav\Documents\R\win-library\3.4\DATA606\labs\Lab6\more #
...
Answer: Each row in table 6 corresponds to a country and the percentage for each answer choice.
...
5%, which is consistent with table 6.
...
Answer: Cases are less than 10% the world population. We also have at least 10 successes and 10 failures. The conditions for inference have been met.
...
Answer: As the population comes closer to .5 the margin of error increases.
...
Mean: 0.09969, Median: 0.09904, IQR: 0.0125, Sd: 0.009287382
...
Answer:  Histograms follow a Normal Distribution and samples are large enough. It is sensible to proceed with inference calculations.


On your own

1. The question of atheism was asked by WIN-Gallup International in a similar survey that was conducted in 2005. (We assume here that sample sizes have remained the same.) Table 4 on page 13 of the report summarizes survey results from 2005 and 2012 for 39 countries.
...
H0 : There is no difference in the athesim index in Spain in 2005 and 2012

HA : There is a difference in the athesim index in Spain in 2005 and 2012
...
H0 : There is no difference in the athesim index in the US in 2005 and 2012

HA : There is a difference in the athesim index in the US in 2005 and 2012

There is no overlap in the intervals for the US in 2005 and 2012, we can say that there is enough evidence to say there is a difference in the athesim index for those years.
...
Answer: The significance level, ??, gives the probability of incorrectly rejecting the null hypothesis, which is a Type 1 error. In this case we would expect 5% to change by chance.
